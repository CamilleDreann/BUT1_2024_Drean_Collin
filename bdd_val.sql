...
(9, 'Haribo Happy Cola', 'Gélifié', 1.95, 'cola.png', 'Bonbons Haribo en forme de bouteille de cola'),
(10, 'Haribo Miami Pik', 'Acide', 2.50, 'miamipik.png', 'Bonbons Haribo acidulés, forme de bâtonnets'),
(11, 'Haribo Goldbears', 'Gélifié', 2.40, 'goldbears.png', 'Bonbons Haribo en forme de petits ours, saveurs fruitées'),
...
(14, 'Haribo Color-Rado', 'Assortiment', 3.00, 'colorrado.png', 'Assortiment de bonbons Haribo'),
(15, 'Haribo Peaches', 'Fruité', 2.20, 'peaches.png', 'Bonbons gélifiés Haribo goût pêche'),
(16, 'Haribo Pico-Balla', 'Fruité', 2.30, 'picoballa.png', 'Bonbons gélifiés Haribo, saveurs fruitées'),
(17, 'Haribo Saure Pommes', 'Acide', 2.40, 'pomme.png', 'Bonbons Haribo acidulés, goût pomme'),
(18, 'Haribo Worms', 'Gélifié', 2.10, 'worms.png', 'Bonbons Haribo en forme de vers, saveurs fruitées'),
(19, 'Haribo Starmix', 'Assortiment', 2.80, 'starmix.png', 'Assortiment de bonbons Haribo, formes variées'),
(20, 'Haribo Twin Cherries', 'Fruité', 2.25, 'cherries.png', 'Bonbons gélifiés Haribo en forme de cerises jumelles'),
(21, 'Haribo Tropifrutti', 'Fruité', 2.50, 'tropifrutti.png', 'Bonbons gélifiés Haribo saveurs tropicales'),
(22, 'Haribo Jelly Babies', 'Gélifié', 2.30, 'jellybabies.png', 'Bonbons gélifiés Haribo en forme de bébés'),
(23, 'Haribo Berry Mix', 'Fruité', 2.70, 'berrymix.png', 'Assortiment de bonbons Haribo goût fruits rouges'),
(24, 'Haribo Fantasia', 'Assortiment', 2.90, 'phantasia.png', 'Assortiment de bonbons Haribo en différentes formes et saveurs'),
(25, 'Haribo Giant Strawbs', 'Fruité', 2.60, 'strawbs.png', 'Bonbons gélifiés Haribo en forme de fraise géante');
